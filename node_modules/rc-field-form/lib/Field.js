...
function (_React$Component) {
  ...
  function Field() {
    ...
    _this.getNamePath = function () {
      ...
      return 'name' in _this.props ? [].concat((0, _toConsumableArray2.default)(prefixName), (0, _toConsumableArray2.default)(namePath)) : [];
    };
    ...
    _this.validateRules = function (options) {
      ...
      var promise = (0, _validateUtil.validateRules)(namePath, _this.getValue(), filteredRules, options, validateFirst);
